...
<div class="full-width about-info inn_padding">
    ...
    <ul id="filters" class="clearfix">
      <li><a><span class="filter active" data-filter=".android-app, .design, .ios-app, .software, .web">Show All</span></a></li>
            	<li><a><span class="filter" data-filter=".android-app">Android App</span></a></li>
    ...
    <div id="portfoliolist" class="full-width">
        ...
        <div class="portfolio-wrapper">
          <div class="full-width port_name">
          	     ...
          	     <a href="../portfolio/ritu-housing/index.html"><img src="https://www.sinontechs.com/wp-content/uploads/2019/12/rituhousing.jpg" alt="" /><h2>Ritu Housing</h2></a>
        ...
        <div class="portfolio-wrapper">
          <div class="full-width port_name">
          	     ...
          	     <a href="../portfolio/just-skip-your-laundry/index.html"><img src="https://www.sinontechs.com/wp-content/uploads/2019/12/rituhousing.jpg" alt="" /><h2>Just Skip Your Laundry</h2></a>
