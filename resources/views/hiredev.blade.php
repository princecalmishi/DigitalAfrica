	...
	<div class="container">
		...
		<div class="row">
							...
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$12/hour</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$13/hour</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$16/hour</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$15/hour</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
							...
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$11/hour</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
							...
							<div class="sr_developer_text full-width">
								...
								<a href="#" class="btn"><span>$300/month</span></a>
							</div>
						</div>
																				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
							<div class="sr_developer_text full-width">
